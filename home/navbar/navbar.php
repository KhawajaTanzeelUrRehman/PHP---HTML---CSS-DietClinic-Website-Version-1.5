        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="../../home/mainpage">Home</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="ProgramDropdown">
                            <li><a class="dropdown-item" href="../../home/Programs/Cards.php">Weight Management
                                    Program</a></li>
                            <li><a class="dropdown-item" href="../../home/Programs/Cards.php">Post Partum Program</a>
                            </li>
                            <li><a class="dropdown-item" href="../../home/Programs/Cards.php">Therapeutic Disease Based
                                    Programs</a></li>
                        </ul>
                    </li>
