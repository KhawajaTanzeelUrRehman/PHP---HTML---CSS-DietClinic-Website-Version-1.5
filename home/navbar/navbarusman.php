                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="ProgramDropdown">
                            <li><a class="dropdown-item" href="../../employee/usman/paymentfromnew.php">Payment From New
                                    Client</a></li>
                            <li><a class="dropdown-item" href="../../employee/usman/approvedpayment.php">Approved
                                    Payments</a></li>
                            <li><a class="dropdown-item" href="../../employee/usman/rejectedpayment.php">Rejected
                                    Payments</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
