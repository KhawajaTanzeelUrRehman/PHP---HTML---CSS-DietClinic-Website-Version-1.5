...
<body>
    ...
    <nav class="navbar navbar-expand-lg  navbar-dark navbar-dark bg-dark sticky-top">
        <div class="container-fluid">
            ...
            <div style="float: right; width: fit-content;" class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../../admin/payments/index.php">Pending Payment Approvals</a>
                    </li>
                ...
                <h4><strong style=" color: white;"><?php
