                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="ProgramDropdown">
                            <li><a class="dropdown-item" href="../../employee/ishaam/paymentfromold.php">Payment From
                                    Existing
                                    Client</a></li>
                            <li><a class="dropdown-item" href="../../employee/ishaam/approvedpayment.php">Approved
                                    Payments</a></li>
                            <li><a class="dropdown-item" href="../../employee/ishaam/rejectedpayment.php">Rejected
                                    Payments</a></li>
