                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="ProgramDropdown">
                            <li><a class="dropdown-item" href="../../employee/paymentfromnew">Payment From New
                                    Client</a></li>
                            <li><a class="dropdown-item" href="../../employee/paymentfromold">Payment From
                                    Existing Client</a></li>
                            <li><a class="dropdown-item" href="../../employee/approvedpayment">Approved
                                    Payments</a></li>
                            <li><a class="dropdown-item" href="../../employee/rejectedpayment/index.php">Rejected
                                    Payments</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
