...
<body>
    ...
    if (isset($_SESSION["type"])) {
        ...
        } elseif ($_SESSION["type"] == "client" && $_SESSION["login"] == true) {
            include '../../home/navbar/navbarclient.php';
            include '../../connection.php';
            $q = "SELECT * from client where client_id = '" . $_SESSION["id"] . "'";
            $result = mysqli_query($conn, $q);
            $r = mysqli_fetch_array($result);

            $q1 = "SELECT * from body_measurements where client_id = '" . $_SESSION["id"] . "' and days = 0";
            $result1 = mysqli_query($conn, $q1);


            $q2 = "SELECT * from client where client_id = '" . $_SESSION["id"] . "'";
            $result2 = mysqli_query($conn, $q2);

            $q3 = "SELECT * from payment_approvals where client_id = '" . $_SESSION["id"] . "' and status = 'share' and clienttype = 'Old'";
            $result3 = mysqli_query($conn, $q3);

            $q4 = "SELECT followup from client where client_id = '" . $_SESSION["id"] . "'";
            $r4 = mysqli_query($conn, $q4);
            $result4 = mysqli_fetch_assoc($r4);
            if ($result4["followup"] != 0) {
    ?>
    <script>
    location.replace("../../client/info3/index.php");
    </script>
    ...
    <?php
            ...
            $_SESSION["phone"] = $r[4];
            $_SESSION["iid"] = $r[5];
            $_SESSION["address"] = $r[6];
            $_SESSION["city"] = $r[7];
            $_SESSION["profession"] = $r[8];
            $_SESSION["comment"] = $r[10];
            if ($_SESSION["fname"] == null || $_SESSION["gender"] == null || $_SESSION["phone"] == null || $_SESSION["iid"] == null) {
            ?>
    <script>
    location.replace("../../client/basicinfo/index.php");
    </script>

    <?php
            }
            if (empty($r1 = mysqli_fetch_assoc($result1)) || !empty(mysqli_fetch_assoc($result3))) {
            ?>
    <script>
    location.replace("../../client/info2/index.php");
    </script>
    ...
    <?php
            ...
            if ($r1['height'] == null || $r1['current_weight'] == null) {
            ?>
    <script>
    location.replace("../../client/info2/index.php");
    </script>
    <?php
        ...
        } elseif ($_SESSION["type"] == "staff" && $_SESSION["login"] == true) {

            if ($_SESSION["name"] == "Usman") {
                include '../../home/navbar/navbarusman.php';
            } else if ($_SESSION["name"] == "eshaam") {
                include '../../home/navbar/navbarishaam.php';
            } else if ($_SESSION["name"] == "Warda") {
                include '../../home/navbar/navbarwarda.php';
            } else if ($_SESSION["name"] == "mahnoor") {
                include '../../home/navbar/navbarmahnoor.php';
            } else if ($_SESSION["name"] == "Noman") {
    ...
    ?><div id="carouselExampleCaptions" class="carousel slide my-1" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item" data-bs-interval="1800">
                <img src="car4.jpg" class="d-block w-100" alt="..." />
                <div class="carousel-caption d-none d-md-block">
