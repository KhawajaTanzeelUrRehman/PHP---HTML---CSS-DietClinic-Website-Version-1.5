    ...
    if ($_SESSION["login"] == true) {
        ...
        if ($action == 'download') {
            ...
            if ($client_type == 'New') {
                ...
                imagestring($image, 2, 30, 540, "Registration Form: https://forms.gle/jVJyUGCkoDqrT8pAA", $text_color);
            ...
            if ($r3[0] == 'download') {
                ...
                header("Location: ../../employee/approvedpayment/index.php?");
            } else {
                $submit = 'false';
                header("Location: ../../employee/approvedpayment/index.php?submit=$submit");
            }
        } else {
            header("Location: ../../employee/approvedpayment/index.php?submit=$submit");
        }
