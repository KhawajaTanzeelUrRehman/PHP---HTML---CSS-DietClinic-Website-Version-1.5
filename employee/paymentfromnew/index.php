...
<body>
    ...
    <div class="alert alert-danger" role="alert">
        <p style="text-align: center; font-size: 18px;">
            ..................................................Phone Number Already Exist, Please Use Payment From
            Existing Client....................................................
        </p>
    </div>
    <?php
    ...
    <div class="container my-4">
        <form id="myform2" method="post" action="../../employee/paymentfromnew/paymentfromnew.php"
            enctype="multipart/form-data">

            <div class="mb-3">
                <label for="input-group-text" class="form-label fw-bold">Phone No</label>
            ...
            <div class="mb-3">
                <label for="input-group-text" class="form-label fw-bold">Insta ID</label>
                <input type="text" name="iid" required="required" class="form-control "
                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
            </div>
            <div class="mb-3">
