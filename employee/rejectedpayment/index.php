...
<body>
    ...
    <div style="margin-left: 75px; margin-right: 75px; border:nonepx; align-content: center;">
        ...
        <table class="table table-bordered">
            ...
            <?php
                    $query = "select * from payment_approvals where status='reject' order by payment_date ";
                    $result = mysqli_query($conn, $query);
                    while ($rows = mysqli_fetch_assoc($result)) {
                    ?>
            <tr>
                <form id="myform" method="post" action="../../employee/rejectedpayment/rejectedpayment.php"
