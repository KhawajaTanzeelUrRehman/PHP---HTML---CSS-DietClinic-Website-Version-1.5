...
<body>
    ...
    <h1 style=" margin: auto; width: fit-content; color: blue; ">Pending Plans</h1>
    <div style="margin-left: 75px; margin-right: 75px; border:nonepx; align-content: center;">
        ...
        <table class="table table-bordered">
            ...
            <?php
                    $query = "select * from payment_approvals where status='formverified' order by payment_date ";
                    ...
                    ?>
            <tr>
                <form id="myform" method="post" action="../../employee/mahnoor/pendingplansaction.php"
                    ...
                    <td style="width: 120px;">
                        <select style="width: fit-content;" name="action" class="form-select form-select-md"
                            ...
                            <option value="generated">Plan Shared</option>
                        </select>
