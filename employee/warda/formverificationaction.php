...
if (isset($_SESSION["login"])) {
    if ($_SESSION["login"] == true) {
        ...
        if ($action == 'generated') {
            $q = "UPDATE payment_approvals set status = 'formverified'  where approval_id = '" . $apid . "'";
            mysqli_query($conn, $q);
            header("Location: ../../employee/warda/formverification.php?");
        } else if ($action == 'edit') {
            ...
            header("Location: Location: ../../employee/warda/formverification.php?submit=$submit");
        }
?>
