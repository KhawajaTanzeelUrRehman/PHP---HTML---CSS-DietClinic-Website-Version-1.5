...
<body>
    ...
    <div style="margin-left: 75px; margin-right: 75px; border:nonepx; align-content: center;">
        ...
        <table class="table table-bordered">
            ...
            <?php
                    $query = "select * from payment_approvals where status='codegenerated' and clienttype = 'Old' and purpose != 'Capsules' and purpose != 'Protein Powder' order by payment_date ";
                    ...
                    ?>
            <tr>
                <form id="myform" method="post" action="../../employee/warda/formverificationaction.php"
